		...
		if ( isset( $_POST['dwqa-question-submit'] ) ) {
			...
			if ( isset( $_POST['_wpnonce'] ) && wp_verify_nonce( esc_html( $_POST['_wpnonce'] ), '_dwqa_submit_question' ) ) {
				if ( $valid_captcha ) {
					...
					$category_1 = isset( $_POST['question-category1'] ) ? intval( $_POST['question-category1'] ) : 0;

					if ( ! term_exists( $category_1, 'dwqa-question_category' ) ) {
						$category_1 = 0;
					}
					...
					$category_2 = isset( $_POST['question-category2'] ) ?
								intval( $_POST['question-category2'] ) : 0;

					if ( ! term_exists( $category_2, 'dwqa-question_category' ) ) {
						$category_2 = 0;
					}
					...
					$category_3 = isset( $_POST['question-category3'] ) ? intval( $_POST['question-category3'] ) : 0;

					if ( ! term_exists( $category_3, 'dwqa-question_category' ) ) {
						$category_3 = 0;
					}
...
$category_4 = isset( $_POST['question-category4'] ) ? intval( $_POST['question-category4'] ) : 0;

					if ( ! term_exists( $category_4, 'dwqa-question_category' ) ) {
						$category_4 = 0;
					}
					...
					$postarr = array(
						...
						'tax_input'      => array(
							'dwqa-question_category'    => $category,
